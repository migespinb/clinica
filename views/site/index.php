...
?>
            ...
            <form role="form">
              <div class="box-body">
                <div class="col-lg-4 col-xs-6">
                  <!-- small box -->
                  <a href="<?php echo Url::to(['compra/create', 'tipo'=>1, 'texto'=>'']) ?>">
                  <div class="small-box bg-purple">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color: white">Sandwich</h3>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-aqua">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color: white">Completos</h3>
                ...
                <div class="col-lg-4 col-xs-6">
                  <!-- small box -->
                  <a href="<?php echo Url::to(['compra/create', 'tipo'=>4, 'texto'=>'']) ?>">
                  <div class="small-box bg-maroon">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color: white">Hamburguesa</h3>
                ...
                <div class="col-lg-6 col-xs-6">
                  ...
                  <div class="small-box bg-green">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color: white">Fajitas</h3>
                ...
                <div class="col-lg-6 col-xs-6">
                  ...
                  <div class="small-box bg-yellow">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color: white">Papas Fritas</h3>
    ...
    <div class="row" id="handroll">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form">
              <div class="box-body">
                <a href="<?php echo Url::to(['compra/create', 'tipo'=>8, 'texto'=>'chef']) ?>">
                <div class="col-lg-6 col-xs-6">
                  <!-- small box -->
                  <div class="small-box bg-aqua">
                    <div class="inner" style="padding: 10px;">
                ...
                <!-- ./col -->
              <a href="<?php echo Url::to(['compra/create', 'tipo'=>8, 'texto'=>'elige']) ?>">
                <div class="col-lg-6 col-xs-6">
                  <!-- small box -->
                  <div class="small-box bg-green">
                    <div class="inner" style="padding: 10px;">
    ...
    <div class="row" id="bowl">
        <!-- left column -->
        <div class="col-md-12">
          <!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Bowl</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
              <div class="box-body">
             <a href="<?php echo Url::to(['compra/create', 'tipo'=>3, 'texto'=>'Wok']) ?>">
                <div class="col-lg-6 col-xs-6">
                  <!-- small box -->
                  <div class="small-box bg-aqua">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color:white">Wok</h3>
                ...
                <!-- ./col -->
              <a href="<?php echo Url::to(['compra/create', 'tipo'=>3, 'texto'=>'Ensalada']) ?>">
                <div class="col-lg-6 col-xs-6">
                  <!-- small box -->
                  <div class="small-box bg-green">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color:white">Ensalada<sup style="font-size: 20px"></sup></h3>
              ...
              <a href="<?php echo Url::to(['compra/create', 'tipo'=>3, 'texto'=>'Gohan']) ?>">
                <div class="col-lg-6 col-xs-6 col-lg-offset-3">
                  <!-- small box -->
                  <div class="small-box bg-yellow">
                    <div class="inner" style="padding: 10px;">
                      <h3 style="color:white">Gohan</h3>
              ...
              <!-- /.box-body -->
              <div class="box-footer">
                <div onclick="regresar_bowl()" class="btn btn-danger btn-block">regresar</div>
              </div>
            </form>
          </div>
        </div>
          ...
          <div class="box box-primary">
            ...
            <form role="form">
              <div class="box-body">
                <div class="col-lg-6 col-xs-6">
                  <!-- small box -->
                  <a href="<?php echo Url::to(['compra/create', 'tipo'=>2, 'texto'=>'frio']) ?>">
                  <div class="small-box bg-aqua">
                    <div class="inner" style="padding: 10px;">
                ...
                <div class="col-lg-6 col-xs-6">
                  <!-- small box -->
                  <a href="<?php echo Url::to(['compra/create', 'tipo'=>2, 'texto'=>'caliente']) ?>">
                  <div class="small-box bg-red">
                    <div class="inner" style="padding: 10px;">
                ...
                <div class="col-lg-6 col-xs-6 col-lg-offset-3">
                  <!-- small box -->
                  <a href="<?php echo Url::to(['compra/create', 'tipo'=>2, 'texto'=>'sin']) ?>">
